...
parser.add_argument("--model_ID",default='dense_dmap_EAF_0815', help='the model ID to be saved')

parser.add_argument("--path_tr_ls",default='data/data_for_training/trainingdata_esthiBCH4cls_BCH5cls_0815.csv', help='the training dataset csv')
