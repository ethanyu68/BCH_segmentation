...
parser.add_argument("--src",default='/home/ethanyu/data/seg_results/VSGS_1013_nii/', help='the folder that contains the NIFTI segmentation files')
parser.add_argument("--dst",default='/home/ethanyu/data/seg_results/vsgs_vol_info.xlsx', help='the path to the location to save the volume info table.')
parser.add_argument("--info",default='/home/ethanyu/MRI_segmentation_pipeline_2024Aug/vsgs_info_1013.xlsx', help='the spreadsheet that has all the information of the patients.')
parser.add_argument("--info_sheet",default='Sheet2', help='the spreadsheet that has all the information of the patients.')
